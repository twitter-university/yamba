...
public class UpdaterService extends IntentService {
	...
	YambaApp yamba;
	Toast toastNewTweets, toastNoNewTweets, toastNotAuthenticated;
	...
	public void onCreate() {
		...
		toastNotAuthenticated = Toast
				.makeText(
						this.getApplicationContext(),
						"You are not authorized yet. Please authorize this app with Twitter first.",
						Toast.LENGTH_LONG);
	}
	...
	protected void onHandleIntent(Intent inIntent) {
		...
		// Assert we got twitter object
		if (yamba.twitter == null) {
			toastNotAuthenticated.show();
			return;
		}
		...
		for (Status status : timeline) {
			...
			uri = getContentResolver().insert(StatusProvider.CONTENT_URI,
					values);
